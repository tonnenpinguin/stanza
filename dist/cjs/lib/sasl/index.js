...
// ====================================================================
// istanbul ignore next
async function createClientNonce(length = 32) {
    return (await Hashes.randomBytes(length)).toString('hex');
}
...
class ANONYMOUS extends SimpleMech {
    ...
    async createResponse(credentials) {
...
class DIGEST extends SimpleMech {
    ...
    async createResponse(credentials) {
        ...
        const cnonce = (_c = credentials.clientNonce) !== null && _c !== void 0 ? _c : (await createClientNonce(16));
        const nc = '00000001';
        const qop = 'auth';
        let str = '';
...
class SCRAM {
    ...
    async initialResponse(credentials) {
        ...
        this.clientNonce = credentials.clientNonce || (await createClientNonce());
        let cbindHeader = 'n';
