...
class Client extends events_1.EventEmitter {
    constructor(opts = {}) {
        ...
        this.outgoingDataQueue = async_1.priorityQueue(async (task, done) => {
            ...
            const ackRequest = replay !== null && replay !== void 0 ? replay : (await this.sm.track(kind, stanza));
            if (kind === 'message') {
                if (replay) {
    ...
    async connect() {
        ...
        for (const name of transportPref) {
            ...
            this.transport.connect({
                acceptLanguages: (_b = this.config.acceptLanguages) !== null && _b !== void 0 ? _b : ['en'],
                jid: this.config.jid,
    ...
    async sendMessage(data) {
        var _a;
        const id = (_a = data.id) !== null && _a !== void 0 ? _a : (await this.nextId());
        const msg = {
            id,
            originId: id,
            ...data
    ...
    async sendIQ(data) {
        ...
        this.send('iq', iq);
        return Utils_1.timeoutPromise(request, ((_a = this.config.timeout) !== null && _a !== void 0 ? _a : 15) * 1000, () => ({
            error: {
                condition: 'timeout'
            },
            id: iq.id,
