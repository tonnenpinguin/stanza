...
function default_1(client) {
    ...
    client.leaveRoom = async (room, nick, opts = {}) => {
        var _a;
        room = JID.toBare(room);
        nick = nick || client.joinedRooms.get(room);
        const id = (_a = opts.id) !== null && _a !== void 0 ? _a : (await Utils_1.uuid());
    ...
    client.changeNick = async (room, nick) => {
        const id = await Utils_1.uuid();
