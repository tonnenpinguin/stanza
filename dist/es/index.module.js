...
function createClientNonce(length = 32) {
    return __awaiter(this, void 0, void 0, function* () {
        return (yield randomBytes(length)).toString('hex');
    });
}
...
const VERSION = '__STANZAJS_VERSION__';
// ====================================================================
...
class JingleSession {
    constructor(opts) {
        ...
        this.sid = opts.sid;
        // This might be problematic as it introduces a race condition
        if (!this.sid) {
            uuid().then(uuid => (this.sid = uuid));
        }
        ...
        this.pendingApplicationTypes = (_a = opts.applicationTypes) !== null && _a !== void 0 ? _a : [];
...
function MUC (client) {
    ...
    client.leaveRoom = (room, nick, opts = {}) => __awaiter(this, void 0, void 0, function* () {
        var _a;
        room = toBare(room);
        nick = nick || client.joinedRooms.get(room);
        const id = (_a = opts.id) !== null && _a !== void 0 ? _a : (yield uuid());
    ...
    client.changeNick = (room, nick) => __awaiter(this, void 0, void 0, function* () {
        const id = yield uuid();
...
class Client extends EventEmitter {
    ...
    _getConfiguredCredentials() {
        ...
        const requestedJID = parse((_b = this.config.jid) !== null && _b !== void 0 ? _b : '');
